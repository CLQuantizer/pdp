/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 03207f5c1495efe0cf3a2fb19f99e5d0)
// Runtime types generated with workerd@1.20250525.0 2024-10-22 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ENV: string;
		AI: string;
		ALTERNATIVE_HYPOTHESES_PROMPT: string;
		ALTERNATIVE_HYPOTHESES_SYSTEM: string;
		DB: D1Database;
		OPENAI_API_KEY: SecretsStoreSecret;
		AI_GATEWAY: SecretsStoreSecret;
		ASSETS: Fetcher;
	}
}
